...
*请输入您偏好语言的数字(1-10)。*""",
        ...
        'option_help': "帮助",
        'option_stop': "停止服务",
        'simple_instruction': "只需输入数字即可选择功能！",
...
*बस अपनी पसंदीदा भाषा का नंबर (1-10) दर्ज करें।*""",
        ...
        'simple_instruction': "बस एक नंबर दर्ज करें फंक्शन चुनने के लिए!",
...
*صرف اپنی پسندیدہ زبان کا نمبر (1-10) داخل کریں۔*""",
        ...
        'simple_instruction': "صرف ایک نمبر داخل کریں فنکشن منتخب کرنے کے لیے!",
...
*শুধুমাত্র আপনার পছন্দের ভাষার নম্বর (1-10) লিখুন।*""",
        ...
        'simple_instruction': "শুধু একটি নম্বর লিখুন ফাংশন নির্বাচন করতে!",
...
*فقط أدخل رقم لغتك المفضلة (1-10).*""",
        ...
        'simple_instruction': "فقط أدخل رقماً لاختيار الوظيفة!",
...
*Simplemente ingrese el número de su idioma preferido (1-10).*""",
        ...
        'simple_instruction': "¡Simplemente ingrese un número para seleccionar una función!",
...
*Simplesmente digite o número do seu idioma preferido (1-10).*""",
        ...
        'invalid_choice': "❌ Escolha inválida. Por favor, digite um número entre",
        'setup_complete': "🎉 *Configuração concluída!*",
        'monitoring_started': "✅ Monitoramento iniciado para suas preferências",
        'status_title': "📊 *Seu status atual*",
        'no_preferences': "❌ Nenhuma preferência definida. Por favor, execute a configuração primeiro.",
        'recent_alerts_title': "📬 *Alertas recentes*",
        'no_recent_alerts': "📭 Nenhum alerta recente encontrado.",
        'trends_title': "📈 *Tendências de tempos de espera*",
        'help_title': "❓ *Ajuda e suporte*",
        'unsubscribe_confirm': "❌ *Serviço parado*\n\nVocê cancelou a inscrição de todos os alertas.",
        'error_occurred': "❌ *Algo deu errado*\n\nPor favor, tente novamente mais tarde, ou:\n\n*1* - Voltar ao menu principal\n*help* - Ver ajuda\n\nSe o problema persistir, entre em contato com o suporte."
    }
}
